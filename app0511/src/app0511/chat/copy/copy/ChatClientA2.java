...
public class ChatClientA2 extends JFrame implements ActionListener, KeyListener{
	JTextArea area;
	JScrollPane scroll;
	JTextField t_input;
	JButton bt, bt_open;
	ChatClientB2 cb; // 내가 제어하고 싶은 상대방창에 대한 레퍼런스 변수
	ChatClientC cc;
	public ChatClientA2() {
		// 생성
...
//			System.out.println("파일을 열겠습니까?");
			...
			cb.setArea2(area, cc.area);
			cc.setArea2(area, cb.area);
